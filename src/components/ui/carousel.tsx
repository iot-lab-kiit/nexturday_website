  ...
  return (
    <div className="w-full h-full flex items-center justify-center">
      ...
      >
        ...
        {/* Content overlay */}
        <div
          className={`absolute bottom-0 left-0 right-0 p-4 md:p-6 lg:p-8 z-10 transition-all duration-300 will-change-transform ${
            isActive
        ...
        >
          <div className="bg-black/30 backdrop-blur-md rounded-xl md:rounded-2xl p-3 md:p-4 lg:p-5 border border-white/20">
            <h3
              className={`font-bold text-white line-clamp-2 transition-all duration-300 ${
                isActive
            ...
            {date && (
              <p
                className={`mt-2 text-gray-200 transition-all duration-300 ${
                  isActive
      ...
      <div className="relative h-[45vh] sm:h-[50vh] md:h-[55vh] lg:h-[60vh] flex items-center justify-center py-4">
        <div className="flex items-center justify-center w-full relative">
          ...
          <div className="flex items-center justify-center space-x-6 md:space-x-8 lg:space-x-12 px-4">
            {[-1, 0, 1].map((offset) => {
              const slideIndex =
                (((current + offset) % totalSlides) + totalSlides) %
                totalSlides;
