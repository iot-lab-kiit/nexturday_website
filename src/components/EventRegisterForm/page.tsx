    ...
    const formFields: FormField[] = [
        {
            ...
            validation: (value) => !value.trim() ? 'First name is required' : undefined
        },
        {
            id: 'lastName',
            type: 'text',
            placeholder: 'Last Name',
            validation: (value) => !value.trim() ? 'Last name is required' : undefined
        },
        {
            id: 'email',
            type: 'email',
        ...
        if (field.type === 'select') {
            return (
                <div key={field.id}>
                    <select
                        id={field.id}
                        className={`${baseClassName} ${formData[field.id as keyof typeof formData] ? 'bg-purple-500' : 'bg-black'} [&>option:checked]:bg-purple-500`}
                ...
                <div className="bg-zinc-900/40 backdrop-blur-xl border border-zinc-800/50 rounded-2xl p-8 md:p-12 shadow-2xl">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-zinc-400 max-w-2xl mx-auto">
                            Fill in your details below to secure your spot at the event. All fields are required.
                        </p>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-8">
                        <div className="space-y-6">
                            <h2 className="text-xl font-semibold text-purple-400 mb-4">Personal Information</h2>
                        ...
                        <div className="space-y-6">
                            <h2 className="text-xl font-semibold text-purple-400 mb-4">Contact Details</h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-6">
                            <h2 className="text-xl font-semibold text-purple-400 mb-4">Academic Information</h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
